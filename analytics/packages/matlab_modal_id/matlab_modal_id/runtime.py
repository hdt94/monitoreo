...
packages = {
    'matlab_modal_id': {'initialized': False, 'package_handle': None}
}


def initialize():
    modal_id_package = packages['matlab_modal_id']
    
    if (modal_id_package['initialized']):
        return modal_id_package['package_handle']
    else:
...
class _PathInitializer(object):
    ...
    def get_paths_from_os(self):
        ...
        path_elements=f"{MCR}/v910/runtime/glnxa64:{MCR}/v910/bin/glnxa64:{MCR}/v910/sys/os/glnxa64:{MCR}/v910/extern/bin/glnxa64:{MCR}/v910/sys/opengl/lib/glnxa64".split(os.pathsep)
    ...
    def initialize_package(self):
        ...
        packages[self.PACKAGE_NAME]= {'initialized': True, 'package_handle': package_handle}
